...
class LogstoreResourceQuotaStorage(TeaModel):
    def __init__(
        self,
        preserved: int = None,
        used: int = None,
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('preserved') is not None:
            self.preserved = m.get('preserved')
        if m.get('used') is not None:
            self.used = m.get('used')
        return self


class LogstoreResourceQuota(TeaModel):
    def __init__(
        self,
        storage: LogstoreResourceQuotaStorage = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('storage') is not None:
            temp_model = LogstoreResourceQuotaStorage()
...
class Logstore(TeaModel):
    def __init__(
        ...
        resource_quota: LogstoreResourceQuota = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resourceQuota') is not None:
            temp_model = LogstoreResourceQuota()
...
class DataScenesValue(TeaModel):
    def __init__(
        self,
        name: str = None,
        description: str = None,
        recommend_question: CopilotAction = None,
        actions: Dict[str, CopilotAction] = None,
        scene: str = None,
    ):
        self.name = name
        self.description = description
        self.recommend_question = recommend_question
        self.actions = actions
        self.scene = scene

    def validate(self):
        if self.recommend_question:
            self.recommend_question.validate()
        if self.actions:
    ...
    def to_map(self):
        ...
        if self.description is not None:
            result['description'] = self.description
        if self.recommend_question is not None:
            result['recommendQuestion'] = self.recommend_question.to_map()
        result['actions'] = {}
        if self.actions is not None:
            for k, v in self.actions.items():
                result['actions'][k] = v.to_map()
        if self.scene is not None:
            result['scene'] = self.scene
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('description') is not None:
            self.description = m.get('description')
        if m.get('recommendQuestion') is not None:
            temp_model = CopilotAction()
            self.recommend_question = temp_model.from_map(m['recommendQuestion'])
        self.actions = {}
        if m.get('actions') is not None:
            for k, v in m.get('actions').items():
                temp_model = CopilotAction()
                self.actions[k] = temp_model.from_map(v)
        if m.get('scene') is not None:
            self.scene = m.get('scene')
        return self
...
class CancelDownloadJobResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class CreateChartRequestDisplay(TeaModel):
    def __init__(
        self,
        height: int = None,
        width: int = None,
...
class CreateChartRequestSearch(TeaModel):
    def __init__(
        self,
        end: str = None,
        logstore: str = None,
...
class CreateChartRequest(TeaModel):
    def __init__(
        self,
        action: Any = None,
        display: CreateChartRequestDisplay = None,
        search: CreateChartRequestSearch = None,
        title: str = None,
        type: str = None,
    ):
        self.action = action
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('action') is not None:
            self.action = m.get('action')
        if m.get('display') is not None:
            temp_model = CreateChartRequestDisplay()
            self.display = temp_model.from_map(m['display'])
        if m.get('search') is not None:
            temp_model = CreateChartRequestSearch()
...
class CreateChartResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class CreateDashboardSharingRequestExtraGlobalTimeSearch(TeaModel):
    def __init__(
        self,
        end: str = None,
        start: str = None,
...
class CreateDashboardSharingRequestExtraTokenTag(TeaModel):
    def __init__(
        self,
        end: int = None,
        key: str = None,
...
class CreateDashboardSharingRequestExtra(TeaModel):
    def __init__(
        self,
        filter_tag: List[str] = None,
        filter_tag_not: List[str] = None,
        global_time_search: CreateDashboardSharingRequestExtraGlobalTimeSearch = None,
        theme: str = None,
        token_tag: List[CreateDashboardSharingRequestExtraTokenTag] = None,
        view_chart: str = None,
    ):
        self.filter_tag = filter_tag
        self.filter_tag_not = filter_tag_not
        self.global_time_search = global_time_search
        self.theme = theme
        self.token_tag = token_tag
        self.view_chart = view_chart

    def validate(self):
        if self.global_time_search:
            self.global_time_search.validate()
        if self.token_tag:
            for k in self.token_tag:
                if k:
                    k.validate()
    ...
    def to_map(self):
        ...
        if self.filter_tag_not is not None:
            result['filterTagNot'] = self.filter_tag_not
        if self.global_time_search is not None:
            result['globalTimeSearch'] = self.global_time_search.to_map()
        if self.theme is not None:
            result['theme'] = self.theme
        result['tokenTag'] = []
        if self.token_tag is not None:
            for k in self.token_tag:
                result['tokenTag'].append(k.to_map() if k else None)
        if self.view_chart is not None:
            result['viewChart'] = self.view_chart
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('filterTagNot') is not None:
            self.filter_tag_not = m.get('filterTagNot')
        if m.get('globalTimeSearch') is not None:
            temp_model = CreateDashboardSharingRequestExtraGlobalTimeSearch()
            self.global_time_search = temp_model.from_map(m['globalTimeSearch'])
        if m.get('theme') is not None:
            self.theme = m.get('theme')
        self.token_tag = []
        if m.get('tokenTag') is not None:
            for k in m.get('tokenTag'):
                temp_model = CreateDashboardSharingRequestExtraTokenTag()
                self.token_tag.append(temp_model.from_map(k))
        if m.get('viewChart') is not None:
            self.view_chart = m.get('viewChart')
        return self


class CreateDashboardSharingRequestSharingTo(TeaModel):
    def __init__(
        self,
        ids: List[str] = None,
        type: str = None,
...
class CreateDashboardSharingRequest(TeaModel):
    def __init__(
        self,
        dashboard_id: str = None,
        expiration_time: int = None,
        extra: CreateDashboardSharingRequestExtra = None,
        name: str = None,
        number: int = None,
        project_name: str = None,
        sharing_to: CreateDashboardSharingRequestSharingTo = None,
    ):
        self.dashboard_id = dashboard_id
        self.expiration_time = expiration_time
        self.extra = extra
    ...
    def to_map(self):
        ...
        if self.project_name is not None:
            result['projectName'] = self.project_name
        if self.sharing_to is not None:
            result['sharingTo'] = self.sharing_to.to_map()
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('expirationTime') is not None:
            self.expiration_time = m.get('expirationTime')
        if m.get('extra') is not None:
            temp_model = CreateDashboardSharingRequestExtra()
        ...
        if m.get('projectName') is not None:
            self.project_name = m.get('projectName')
        if m.get('sharingTo') is not None:
            temp_model = CreateDashboardSharingRequestSharingTo()
            self.sharing_to = temp_model.from_map(m['sharingTo'])
        return self


class CreateDashboardSharingResponseBody(TeaModel):
    def __init__(
        self,
        ticket: str = None,
        ticket_id: str = None,
...
class CreateDashboardSharingResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateDashboardSharingResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateDashboardSharingResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class CreateExternalStoreRequestParameter(TeaModel):
    def __init__(
        self,
        db: str = None,
        host: str = None,
...
class CreateExternalStoreRequest(TeaModel):
    def __init__(
        self,
        external_store_name: str = None,
        parameter: CreateExternalStoreRequestParameter = None,
        store_type: str = None,
    ):
        # This parameter is required.
        self.external_store_name = external_store_name
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('externalStoreName') is not None:
            self.external_store_name = m.get('externalStoreName')
        if m.get('parameter') is not None:
            temp_model = CreateExternalStoreRequestParameter()
...
class CreateExternalStoreResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class CreateLabelRequestSettings(TeaModel):
    def __init__(
        self,
        config: str = None,
        mode: str = None,
...
class CreateLabelRequest(TeaModel):
    def __init__(
        ...
        label_id: str = None,
        name: str = None,
        settings: List[CreateLabelRequestSettings] = None,
        type: str = None,
    ):
        self.aliuid = aliuid
        self.description = description
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('settings') is not None:
            for k in m.get('settings'):
                temp_model = CreateLabelRequestSettings()
                self.settings.append(temp_model.from_map(k))
        if m.get('type') is not None:
            self.type = m.get('type')
        return self
...
class CreateProcessConfigRequestConfigMatcher(TeaModel):
    def __init__(
        self,
        agent_type: str = None,
        cluster: str = None,
...
class CreateProcessConfigRequest(TeaModel):
    def __init__(
        self,
        config_name: str = None,
        config: str = None,
        config_matcher: CreateProcessConfigRequestConfigMatcher = None,
        is_gray: bool = None,
    ):
        self.config_name = config_name
        self.config = config
    ...
    def validate(self):
        if self.config_matcher:
            self.config_matcher.validate()
    ...
    def to_map(self):
        ...
        if self.config is not None:
            result['config'] = self.config
        if self.config_matcher is not None:
            result['configMatcher'] = self.config_matcher.to_map()
        if self.is_gray is not None:
            result['isGray'] = self.is_gray
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('config') is not None:
            self.config = m.get('config')
        if m.get('configMatcher') is not None:
            temp_model = CreateProcessConfigRequestConfigMatcher()
            self.config_matcher = temp_model.from_map(m['configMatcher'])
        if m.get('isGray') is not None:
            self.is_gray = m.get('isGray')
        return self


class CreateProcessConfigResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class CreateUnifiedObservabilityModelInstanceRequest(TeaModel):
    def __init__(
        self,
        desc: str = None,
        id: str = None,
...
class CreateUnifiedObservabilityModelInstanceResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class DeleteChartResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class DeleteDashboardSharingRequest(TeaModel):
    def __init__(
        self,
        dashboard_id: str = None,
        project_name: str = None,
...
class DeleteDashboardSharingResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class DeleteUnifiedObservabilityModelInstanceResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class GetAgentConfigRequest(TeaModel):
    def __init__(
        self,
        body: bytes = None,
    ):
...
class GetAgentConfigResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class GetChartResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class GetCopilotChatResultRequestChatParam(TeaModel):
    def __init__(
        self,
        action: str = None,
        query: str = None,
...
class GetCopilotChatResultRequest(TeaModel):
    def __init__(
        self,
        chat_param: GetCopilotChatResultRequestChatParam = None,
        copilot_param: Dict[str, str] = None,
        language: str = None,
        region_id: str = None,
        scene_param: Dict[str, str] = None,
    ):
        self.chat_param = chat_param
        self.copilot_param = copilot_param
        self.language = language
        self.region_id = region_id
    ...
    def to_map(self):
        ...
        result = dict()
        if self.chat_param is not None:
            result['chatParam'] = self.chat_param.to_map()
        if self.copilot_param is not None:
            result['copilotParam'] = self.copilot_param
        if self.language is not None:
            result['language'] = self.language
        if self.region_id is not None:
            result['regionId'] = self.region_id
        if self.scene_param is not None:
            result['sceneParam'] = self.scene_param
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('chatParam') is not None:
            temp_model = GetCopilotChatResultRequestChatParam()
            self.chat_param = temp_model.from_map(m['chatParam'])
        if m.get('copilotParam') is not None:
            self.copilot_param = m.get('copilotParam')
        if m.get('language') is not None:
            self.language = m.get('language')
        if m.get('regionId') is not None:
            self.region_id = m.get('regionId')
        if m.get('sceneParam') is not None:
            self.scene_param = m.get('sceneParam')
        return self


class GetCopilotChatResultResponseBodyDataNextActions(TeaModel):
    def __init__(
        self,
        backend_action: Any = None,
        frontend_action: Any = None,
    ...
    def to_map(self):
        ...
        if self.backend_action is not None:
            result['backendAction'] = self.backend_action
        if self.frontend_action is not None:
            result['frontendAction'] = self.frontend_action
        if self.processor_type is not None:
            result['processorType'] = self.processor_type
        if self.type is not None:
            result['type'] = self.type
        if self.variables is not None:
            result['variables'] = self.variables
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('backendAction') is not None:
            self.backend_action = m.get('backendAction')
        if m.get('frontendAction') is not None:
            self.frontend_action = m.get('frontendAction')
        if m.get('processorType') is not None:
            self.processor_type = m.get('processorType')
        if m.get('type') is not None:
            self.type = m.get('type')
        if m.get('variables') is not None:
            self.variables = m.get('variables')
...
class GetCopilotChatResultResponseBodyData(TeaModel):
    def __init__(
        self,
        answer: str = None,
        auto_action: str = None,
        copilot_conversation_id: str = None,
        message_id: str = None,
        next_actions: List[GetCopilotChatResultResponseBodyDataNextActions] = None,
        scene_conversation_id: str = None,
        scene_variables: Dict[str, str] = None,
        type: str = None,
    ):
        self.answer = answer
        self.auto_action = auto_action
        self.copilot_conversation_id = copilot_conversation_id
        self.message_id = message_id
        self.next_actions = next_actions
        self.scene_conversation_id = scene_conversation_id
        self.scene_variables = scene_variables
        self.type = type

    def validate(self):
        if self.next_actions:
            for k in self.next_actions:
                if k:
                    k.validate()
    ...
    def to_map(self):
        ...
        if self.auto_action is not None:
            result['autoAction'] = self.auto_action
        if self.copilot_conversation_id is not None:
            result['copilotConversationId'] = self.copilot_conversation_id
        if self.message_id is not None:
            result['messageId'] = self.message_id
        result['nextActions'] = []
        if self.next_actions is not None:
            for k in self.next_actions:
                result['nextActions'].append(k.to_map() if k else None)
        if self.scene_conversation_id is not None:
            result['sceneConversationId'] = self.scene_conversation_id
        if self.scene_variables is not None:
            result['sceneVariables'] = self.scene_variables
        if self.type is not None:
            result['type'] = self.type
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('autoAction') is not None:
            self.auto_action = m.get('autoAction')
        if m.get('copilotConversationId') is not None:
            self.copilot_conversation_id = m.get('copilotConversationId')
        if m.get('messageId') is not None:
            self.message_id = m.get('messageId')
        self.next_actions = []
        if m.get('nextActions') is not None:
            for k in m.get('nextActions'):
                temp_model = GetCopilotChatResultResponseBodyDataNextActions()
                self.next_actions.append(temp_model.from_map(k))
        if m.get('sceneConversationId') is not None:
            self.scene_conversation_id = m.get('sceneConversationId')
        if m.get('sceneVariables') is not None:
            self.scene_variables = m.get('sceneVariables')
        if m.get('type') is not None:
            self.type = m.get('type')
        return self


class GetCopilotChatResultResponseBody(TeaModel):
    def __init__(
        self,
        data: GetCopilotChatResultResponseBodyData = None,
        message: str = None,
        success: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = GetCopilotChatResultResponseBodyData()
...
class GetCopilotChatResultResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetCopilotChatResultResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetCopilotChatResultResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class GetCopilotMetaRequest(TeaModel):
    def __init__(
        self,
        language: str = None,
        region_id: str = None,
...
class GetCopilotMetaResponseBodyData(TeaModel):
    def __init__(
        self,
        scenes: Dict[str, DataScenesValue] = None,
    ):
        self.scenes = scenes
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('scenes') is not None:
            for k, v in m.get('scenes').items():
                temp_model = DataScenesValue()
                self.scenes[k] = temp_model.from_map(v)
        return self


class GetCopilotMetaResponseBody(TeaModel):
    def __init__(
        self,
        data: GetCopilotMetaResponseBodyData = None,
        message: str = None,
        success: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('data') is not None:
            temp_model = GetCopilotMetaResponseBodyData()
            self.data = temp_model.from_map(m['data'])
        if m.get('message') is not None:
            self.message = m.get('message')
        if m.get('success') is not None:
...
class GetCopilotMetaResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetCopilotMetaResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetCopilotMetaResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetDashboardSharingRequest(TeaModel):
    def __init__(
        self,
        dashboard_id: str = None,
        project_name: str = None,
...
class GetDashboardSharingResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class GetMLServiceResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: MLServiceParam = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
...
class GetProcessorAssociateResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ProcessorAssociate = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ProcessorAssociate()
            self.body = temp_model.from_map(m['body'])
        return self


class GetProductDataCollectionRequest(TeaModel):
    def __init__(
        self,
        data_type: str = None,
        instance_id: str = None,
        ...
        self.target_slsregion = target_slsregion
    ...
    def to_map(self):
        ...
        if self.target_slsregion is not None:
            result['targetSLSRegion'] = self.target_slsregion
        if self.target_store is not None:
            result['targetStore'] = self.target_store
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('targetSLSRegion') is not None:
            self.target_slsregion = m.get('targetSLSRegion')
        if m.get('targetStore') is not None:
            self.target_store = m.get('targetStore')
        return self


class GetProductDataCollectionResponseBody(TeaModel):
    def __init__(
        self,
        data_type: str = None,
...
class GetProductDataCollectionResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetProductDataCollectionResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetProductDataCollectionResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ListAllProjectsRequest(TeaModel):
    def __init__(
        self,
        offset: int = None,
        project_name: str = None,
...
class ListAllProjectsResponseBody(TeaModel):
    def __init__(
        self,
        count: int = None,
...
class ListAllProjectsResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListAllProjectsResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ListAllProjectsResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ListDashboardSharingRequest(TeaModel):
    def __init__(
        self,
        dashboard_id: str = None,
        hide_expire: bool = None,
        offset: int = None,
        project_name: str = None,
        size: int = None,
    ):
    ...
    def to_map(self):
        ...
        if self.dashboard_id is not None:
            result['dashboardId'] = self.dashboard_id
        if self.hide_expire is not None:
            result['hideExpire'] = self.hide_expire
        if self.offset is not None:
            result['offset'] = self.offset
        if self.project_name is not None:
            result['projectName'] = self.project_name
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dashboardId') is not None:
            self.dashboard_id = m.get('dashboardId')
        if m.get('hideExpire') is not None:
            self.hide_expire = m.get('hideExpire')
        if m.get('offset') is not None:
            self.offset = m.get('offset')
        if m.get('projectName') is not None:
            self.project_name = m.get('projectName')
...
class ListDashboardSharingResponseBody(TeaModel):
    def __init__(
        self,
        offset: int = None,
        size: int = None,
        ticket_info_list: List[Ticket] = None,
        total: int = None,
    ):
        self.offset = offset
        self.size = size
    ...
    def to_map(self):
        ...
        if self.size is not None:
            result['size'] = self.size
        result['ticketInfoList'] = []
        if self.ticket_info_list is not None:
            for k in self.ticket_info_list:
                result['ticketInfoList'].append(k.to_map() if k else None)
        if self.total is not None:
            result['total'] = self.total
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ticketInfoList') is not None:
            for k in m.get('ticketInfoList'):
                temp_model = Ticket()
...
class ListDashboardSharingResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListDashboardSharingResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ListDashboardSharingResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ListProjectsInRecycleBinRequest(TeaModel):
    def __init__(
        self,
        offset: int = None,
        project_name: str = None,
...
class ListProjectsInRecycleBinResponseBody(TeaModel):
    def __init__(
        self,
        count: int = None,
        projects: List[ProjectSummary] = None,
...
class ListProjectsInRecycleBinResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListProjectsInRecycleBinResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ListProjectsInRecycleBinResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class PostLogStoreLogsHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
...
class PostLogStoreLogsRequest(TeaModel):
    def __init__(
        self,
        body: LogGroup = None,
    ):
...
class PostLogStoreLogsResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class PreviewSPLRequest(TeaModel):
    def __init__(
        self,
        input: List[Dict[str, str]] = None,
        mode: str = None,
...
class PreviewSPLResponseBodyInfo(TeaModel):
    def __init__(
        self,
        datasets: List[str] = None,
        failed_lines: int = None,
        raw_data_lines: int = None,
        ...
        # This parameter is required.
        self.raw_data_lines = raw_data_lines
        # This parameter is required.
    ...
    def to_map(self):
        ...
        if self.datasets is not None:
            result['datasets'] = self.datasets
        if self.failed_lines is not None:
            result['failedLines'] = self.failed_lines
        if self.raw_data_lines is not None:
            result['rawDataLines'] = self.raw_data_lines
        if self.result_lines is not None:
            result['resultLines'] = self.result_lines
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('datasets') is not None:
            self.datasets = m.get('datasets')
        if m.get('failedLines') is not None:
            self.failed_lines = m.get('failedLines')
        if m.get('rawDataLines') is not None:
            self.raw_data_lines = m.get('rawDataLines')
        if m.get('resultLines') is not None:
            self.result_lines = m.get('resultLines')
        return self


class PreviewSPLResponseBody(TeaModel):
    def __init__(
        self,
        data: List[Dict[str, str]] = None,
        info: PreviewSPLResponseBodyInfo = None,
        meta: List[List[str]] = None,
    ):
        self.data = data
        # This parameter is required.
        self.info = info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('info') is not None:
            temp_model = PreviewSPLResponseBodyInfo()
...
class PreviewSPLResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: PreviewSPLResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = PreviewSPLResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UpdateChartRequestDisplay(TeaModel):
    def __init__(
        self,
        height: int = None,
        width: int = None,
...
class UpdateChartRequestSearch(TeaModel):
    def __init__(
        self,
        end: str = None,
        logstore: str = None,
...
class UpdateChartRequest(TeaModel):
    def __init__(
        self,
        action: Dict[str, str] = None,
        display: UpdateChartRequestDisplay = None,
        search: UpdateChartRequestSearch = None,
        title: str = None,
        type: str = None,
    ):
        self.action = action
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('action') is not None:
            self.action = m.get('action')
        if m.get('display') is not None:
            temp_model = UpdateChartRequestDisplay()
            self.display = temp_model.from_map(m['display'])
        if m.get('search') is not None:
            temp_model = UpdateChartRequestSearch()
            self.search = temp_model.from_map(m['search'])
        if m.get('title') is not None:
            self.title = m.get('title')
        if m.get('type') is not None:
...
class UpdateChartResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class UpdateDashboardSharingRequestExtraGlobalTimeSearch(TeaModel):
    def __init__(
        self,
        end: str = None,
        start: str = None,
...
class UpdateDashboardSharingRequestExtraTokenTag(TeaModel):
    def __init__(
        self,
        end: int = None,
        key: str = None,
...
class UpdateDashboardSharingRequestExtra(TeaModel):
    def __init__(
        self,
        filter_tag: List[str] = None,
        filter_tag_not: List[str] = None,
        global_time_search: UpdateDashboardSharingRequestExtraGlobalTimeSearch = None,
        theme: str = None,
        token_tag: List[UpdateDashboardSharingRequestExtraTokenTag] = None,
        view_chart: str = None,
    ):
        self.filter_tag = filter_tag
        self.filter_tag_not = filter_tag_not
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('filterTagNot') is not None:
            self.filter_tag_not = m.get('filterTagNot')
        if m.get('globalTimeSearch') is not None:
            temp_model = UpdateDashboardSharingRequestExtraGlobalTimeSearch()
            self.global_time_search = temp_model.from_map(m['globalTimeSearch'])
        if m.get('theme') is not None:
            self.theme = m.get('theme')
        self.token_tag = []
        if m.get('tokenTag') is not None:
            for k in m.get('tokenTag'):
                temp_model = UpdateDashboardSharingRequestExtraTokenTag()
                self.token_tag.append(temp_model.from_map(k))
        if m.get('viewChart') is not None:
            self.view_chart = m.get('viewChart')
        return self
...
class UpdateDashboardSharingRequestSharingTo(TeaModel):
    def __init__(
        self,
        ids: List[str] = None,
        type: str = None,
...
class UpdateDashboardSharingRequest(TeaModel):
    def __init__(
        self,
        dashboard_id: str = None,
        expiration_time: int = None,
        extra: UpdateDashboardSharingRequestExtra = None,
        name: str = None,
        number: int = None,
        project_name: str = None,
        sharing_to: UpdateDashboardSharingRequestSharingTo = None,
        valid: bool = None,
    ):
        self.dashboard_id = dashboard_id
        self.expiration_time = expiration_time
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('expirationTime') is not None:
            self.expiration_time = m.get('expirationTime')
        if m.get('extra') is not None:
            temp_model = UpdateDashboardSharingRequestExtra()
            self.extra = temp_model.from_map(m['extra'])
        if m.get('name') is not None:
            self.name = m.get('name')
        if m.get('number') is not None:
        ...
        if m.get('projectName') is not None:
            self.project_name = m.get('projectName')
        if m.get('sharingTo') is not None:
            temp_model = UpdateDashboardSharingRequestSharingTo()
            self.sharing_to = temp_model.from_map(m['sharingTo'])
        if m.get('valid') is not None:
            self.valid = m.get('valid')
        return self
...
class UpdateDashboardSharingResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class UpdateExternalStoreRequestParameter(TeaModel):
    def __init__(
        self,
        db: str = None,
        host: str = None,
...
class UpdateExternalStoreRequest(TeaModel):
    def __init__(
        self,
        external_store_name: str = None,
        parameter: UpdateExternalStoreRequestParameter = None,
        store_type: str = None,
    ):
        # This parameter is required.
        self.external_store_name = external_store_name
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('externalStoreName') is not None:
            self.external_store_name = m.get('externalStoreName')
        if m.get('parameter') is not None:
            temp_model = UpdateExternalStoreRequestParameter()
            self.parameter = temp_model.from_map(m['parameter'])
        if m.get('storeType') is not None:
            self.store_type = m.get('storeType')
        return self
...
class UpdateExternalStoreResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
...
class UpdateProcessorAssociateRequest(TeaModel):
    def __init__(
        self,
        processor_id: str = None,
    ):
...
class UpdateProcessorAssociateResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
