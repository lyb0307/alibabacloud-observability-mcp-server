...
from alibabacloud_sls20201230.models import GetIndexResponse,GetIndexResponseBody,IndexKey,IndexJsonKey
...
def get_log_store_index(
    ...
    """
    sls_client:Client = ctx.request_context.lifespan_context["sls_client"].with_region(region_id)
